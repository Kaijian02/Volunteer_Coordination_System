...
if (isset($_GET['user_id'])) {
    ...
    $stmt_reviews->close(); // Close after reviews query is done

    // Fetch attendance counts for this user
    ...
    $attendanceCountsStmt->close(); // Close after attendance query is done

    // Count the total number of distinct events the user has joined
    $totalEventsQuery = "
    ...
    $totalEventsStmt->close(); // Close after total events query is done
